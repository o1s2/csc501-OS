...
//OS proj 3 modify
bs_map_t bsm_tab[MAX_ID]; //backing store table for 16 backing stores MAX_ID is defined as 16
fr_map_t frm_tab[NFRAMES]; //frame table of size 1024
int global_pagetable_fr[4] ;
unsigned long global_pagetable_addr[4];
